...
from carrefourPageScraper import CarrefourPageScraper
from geventQueue import ScraperGeventQueue
from carrefourCategories import CATEGORIES
...
def main():
    ...
    scrapers = ScraperGeventQueue(CarrefourPageScraper,categories)
    scrapers.start()
